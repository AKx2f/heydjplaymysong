...
<title>Hey DJ Play My Song - Change password</title>
</head>
...
<form action="#" method='post'>
	...
	<input type="text" name="email" id="joyemail" placeholder="email" value="<?php print $userid;?>"data-theme="b"/>
	<input type="password" id="joycurrent" name="password" placeholder="current password" data-theme="b"/>
			...
			if ($password2 == $password3){
				...
				if ($rs){
					...
					if (strlen ($password3)<13 && strlen($password3)>5){
							...
							echo "<script type='text/javascript'>alert('Your password has been reset.'); window.location.href = 'dashboard.php';</script>";				
					}
					else{
